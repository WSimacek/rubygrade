...
# The default config/database.yml is configured for Sqlite. (you can copy one of the other sample files in there and edit it if you need)
...
For bugs or suggestions head over to:
